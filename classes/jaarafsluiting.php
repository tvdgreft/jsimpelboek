...
class Jaarafsluiting extends Overzichten
{
    ...
    function FormJaarafsluiting()
    {
		...
		$openboekingen = $dbio->ReadRecords(array("table"=>$table_boekingen,"filter"=>"tegenrekening=''","filters"=>array("datum"=>$boekjaar)));
    ...
    */
    function WriteJaarafsluiting()
    {
        ...
        $boekhouding = $dbio->ReadUniqueRecord(array("table"=>Dbtables::boekhoudingen['name'],"key"=>"code","value"=>$GLOBALS['boekhouding']));
        $boekjaar = $boekhouding->boekjaar;
        $balanstable = Dbtables::balans['name']."_".$GLOBALS['boekhouding'];
		//
        ...
        // boekjaar ophogen
        $dbio->ModifyRecord(array("table"=>Dbtables::boekhoudingen['name'],"key"=>"code","value"=>$GLOBALS['boekhouding'],"fields"=>["boekjaar"=>$boekjaar+1]));
        $boekhouding = $dbio->ReadUniqueRecord(array("table"=>Dbtables::boekhoudingen['name'],"key"=>"code","value"=>$GLOBALS['boekhouding']));
