...
//
		...
		//
		// check if btw is percentage with or without , with 2 decimals (18 and 18,50 is valid)
		//
		var value = document.getElementById("btwpercentage");
		var regex = /^[1-9]?[0-9](\,[0-9]{2})?$/;
		if(regex.test(value.value) == false)
		{
			document.getElementById('btwpercentage').style.borderColor = "red";
			alert("btwpercentage heel getal of , met 2 decimalen");
			alert(value.value);
			return false;
		}
		return true;
